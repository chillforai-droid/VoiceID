  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-32 pb-20 px-6 max-w-4xl mx-auto">
        <h1 className="text-5xl font-extrabold tracking-tighter mb-8">VoiceID Blog</h1>
        <div className="space-y-16">
          <article>
            <h2 className="text-4xl font-bold mb-4">Why Your Phone Number is Not a Safe Identity</h2>
          ...
          <article>
            <h2 className="text-4xl font-bold mb-4">Introducing Secure End-to-End Encryption</h2>
          ...
          <article>
            <h2 className="text-4xl font-bold mb-4">The Future of Decentralized Communication</h2>
